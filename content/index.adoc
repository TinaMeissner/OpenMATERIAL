...
:sectnums:
include::./general_docs/scope.adoc[leveloffset=+2]
include::./general_docs/normative_references.adoc[leveloffset=+2]
include::./general_docs/abbreviations.adoc[leveloffset=+2]
include::./general_docs/backward_compatibility.adoc[leveloffset=+2]
include::./terms_and_definitions/terms_and_definitions.adoc[leveloffset=+2]
include::./use_cases/use_cases.adoc[leveloffset=+2]
